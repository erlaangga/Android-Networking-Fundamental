...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "http://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2016-12-01&endtime=2017-01-01&minmagnitude=6";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            if(earthquakeJSON.length() == 0 || earthquakeJSON.equals("")){
                return null;
            }
            try {
